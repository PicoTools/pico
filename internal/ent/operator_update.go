...
func (ou *OperatorUpdate) RemoveCommandIDs(ids ...int64) *OperatorUpdate {
	ou.mutation.RemoveCommandIDs(ids...)
	return ou
}
...
func (ou *OperatorUpdate) RemoveCommand(c ...*Command) *OperatorUpdate {
	...
	return ou.RemoveCommandIDs(ids...)
}
...
func (ou *OperatorUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if ou.mutation.CommandCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   operator.CommandTable,
			Columns: []string{operator.CommandColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := ou.mutation.RemovedCommandIDs(); len(nodes) > 0 && !ou.mutation.CommandCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   operator.CommandTable,
	...
	if nodes := ou.mutation.CommandIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   operator.CommandTable,
...
func (ouo *OperatorUpdateOne) AddCommandIDs(ids ...int64) *OperatorUpdateOne {
	ouo.mutation.AddCommandIDs(ids...)
	return ouo
}
...
func (ouo *OperatorUpdateOne) RemoveCommand(c ...*Command) *OperatorUpdateOne {
	...
	return ouo.RemoveCommandIDs(ids...)
}
...
func (ouo *OperatorUpdateOne) sqlSave(ctx context.Context) (_node *Operator, err error) {
	...
	if ouo.mutation.CommandCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   operator.CommandTable,
	...
	if nodes := ouo.mutation.RemovedCommandIDs(); len(nodes) > 0 && !ouo.mutation.CommandCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   operator.CommandTable,
	...
	if nodes := ouo.mutation.CommandIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   operator.CommandTable,
