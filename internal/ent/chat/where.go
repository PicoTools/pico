...
func AuthorID(v int64) predicate.Chat {
	return predicate.Chat(sql.FieldEQ(FieldAuthorID, v))
}
...
func IsServer(v bool) predicate.Chat {
	return predicate.Chat(sql.FieldEQ(FieldIsServer, v))
}
...
func IsServerNEQ(v bool) predicate.Chat {
	return predicate.Chat(sql.FieldNEQ(FieldIsServer, v))
}
