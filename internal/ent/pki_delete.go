...
func (pd *PkiDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(pki.Table, sqlgraph.NewFieldSpec(pki.FieldID, field.TypeInt))
...
func (pdo *PkiDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{pki.Label}
	default:
		return nil
	}
}
